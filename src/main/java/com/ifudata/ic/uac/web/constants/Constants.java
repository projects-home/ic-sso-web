package com.ifudata.ic.uac.web.constants;
...
public final class Constants {
	...
	public static final class LoginConstant{
		...
		/** 缓存命名空间*/
		public static final String CACHE_NAMESPACE = "com.ifudata.ic.sso.login.cache";
	}
	...
	public static final class RetakePassword{
		...
		/** 缓存命名空间*/
		public static final String CACHE_NAMESPACE = "com.ifudata.ic.sso.retakepassword.cache";
    ...
    public static final class Register {
        ...
        /** 缓存命名空间 */
        public static final String CACHE_NAMESPACE = "com.ifudata.ic.sso.register.cache";
        /**IP发送短信次数缓存key*/
    ...
    public static final class UpdatePassword{
		...
		/** 缓存命名空间*/
		public static final String CACHE_NAMESPACE = "com.ifudata.ic.sso.updatepassword.cache";
    ...
    public static final class UpdatePhone{
		...
		/** 缓存命名空间*/
		public static final String CACHE_NAMESPACE = "com.ifudata.ic.sso.updatephone.cache";
    ...
    public static final class UpdateEmail{
		...
		/** 缓存命名空间*/
		public static final String CACHE_NAMESPACE = "com.ifudata.ic.sso.updateemail.cache";
    ...
    public static final class BandEmail{
		...
		/** 缓存命名空间*/
		public static final String CACHE_NAMESPACE = "com.ifudata.ic.sso.bandemail.cache";
